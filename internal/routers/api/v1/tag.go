...
func (t Tag) List(c *gin.Context) {
    ...
    if err := api.Validate(c, param); err != nil {
    ...
    totalRows, err := svc.CountTag(&service.CountTagRequest{Name: param.Name,
        State: param.State})
    if err != nil {
        global.Logger.Errorf("svc.CountTagRequest err: %v", err)
